  ...
  Zayn: {
    ...
    projects: [
      ...
      },
      {
        ...
        desc:
          'No one is gonna read this, so I just write some random words here',
        link: 'http://zaynjarvis.com'
      },
      {
        ...
        desc:
          'Этот проект потрясающий, но больно в том, что этот человек не знает русского!',
        link: 'http://zaynjarvis.com'
      }
    ],
    comments: [
