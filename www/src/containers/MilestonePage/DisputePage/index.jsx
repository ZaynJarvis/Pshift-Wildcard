			...
			<Container>
				<Row>
					<Col>
						...
						<p>
							Discuss on the Project structure. Reach Consensus on SCOPE, PERFORMANCE, ROBUSTNESS.
							Deliver UI MockUp.
						</p>
						<Form>
							<Form.Group>
							...
							<Button variant="outline-secondary" block style={{ marginTop: '20px' }}>
								Upload material
							</Button>
							<Link to="/projects">
								<Button variant="outline-dark" block style={{ marginTop: '20px' }}>
									Submit
								</Button>
							</Link>
						</Form>
