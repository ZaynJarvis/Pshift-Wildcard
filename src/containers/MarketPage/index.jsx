...
class Marketplace extends Component {
  ...
  render () {
    ...
    const filteredProjects = projects.filter(createFilter(this.state.searchTerm, KEYS_TO_FILTERS))
    ...
    return (
		<Layout title="Marketplace">
			<Container>
				...
				<Row>
					<Col>
						<SearchInput className="search-input form-control" onChange={this.searchUpdated} />
					</Col>
				</Row>
